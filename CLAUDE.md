...
| `MILESTONES.md` | Planning the next milestone, or checking what a past one concluded. Results ledger for M0–M13 (condensed); no live milestone |
| `docs/MILESTONES-ARCHIVE.md` | You need a completed milestone (M0–M13) **in full** — original plans, build phasing, file manifests, complete results tables, run logs. Read on demand only |
