...
| `MILESTONES.md` | Planning the next milestone, or checking what a past one concluded. Results ledger for M0–M12 (condensed) + the live M13 plan |
| `docs/MILESTONES-ARCHIVE.md` | You need a completed milestone (M0–M12) **in full** — original plans, build phasing, file manifests, complete results tables, run logs. Read on demand only |
